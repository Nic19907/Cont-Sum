...
;----------------- loop principal--------------------
loop:
    btfsc ((PORTC) and 07Fh), 0 ;revisa si el boton fue precionado, en el caso que
      ;si se ejecuta la siguiente instrucion
    call inc_A
    btfsc ((PORTC) and 07Fh), 1 ;lo mismo que ((PORTC) and 07Fh), 0
    call dec_A

    btfsc ((PORTC) and 07Fh), 2
    call inc_B
    btfsc ((PORTC) and 07Fh), 3
    call dec_B
...
inc_A:
    ...
    btfsc ((PORTC) and 07Fh), 0 ;(el boton esta ciendo precionado) hasta que no se
